...
#### Local materials
Materials can be defined in any module, such as MaterialsGeoModule.cc/inc, and are now accessed in other modules via their Geant global material names through context->GetMaterial("some_name")
#### NIST materials
